...
__LinkDB_t*    __LINK_DB_createHead          ( void* object ){
    __LinkDB_t *ptr = (__LinkDB_t*)RH_MALLOC(sizeof(__LinkDB_t));
#ifdef RH_DEBUG
    RH_ASSERT( ptr );
#endif
...
__LinkDB_t*    __LINK_DB_addTail             ( const __LinkDB_t *pHead , void* object ){
    ...
    __LinkDB_t* pNewNode  = (__LinkDB_t*)RH_MALLOC( sizeof(__LinkDB_t) );
#ifdef RH_DEBUG
    RH_ASSERT( pNewNode );
#endif
...
__LinkLoop_t*  __LINK_Loop_createHead        ( void* object ){
    __LinkLoop_t *ptr = (__LinkLoop_t*)RH_MALLOC(sizeof(__LinkLoop_t));
#ifdef RH_DEBUG
    RH_ASSERT( ptr );
#endif
...
__LinkLoop_t * __LINK_Loop_add               ( const __LinkLoop_t *pHead , void* object ){
    ...
    __LinkLoop_t* pNewNode  = (__LinkLoop_t*)RH_MALLOC( sizeof(__LinkLoop_t) );
#ifdef RH_DEBUG
    RH_ASSERT( pNewNode );
#endif
...
__LinkBiTree_t* __LINK_BiTree_createHead     ( void* object ){
    __LinkBiTree_t* pNewHead = (__LinkBiTree_t*)RH_MALLOC(sizeof(__LinkBiTree_t));
#ifdef RH_DEBUG
    RH_ASSERT( pNewHead );
#endif
...
__LinkBiTree_t* __LINK_BiTree_add_l2r        ( const __LinkBiTree_t *pHead , __LinkBiTree_t *pTarget , void* object ){
    ...
    RH_ASSERT( pTarget );
#endif
    __LinkBiTree_t* pNewNode = (__LinkBiTree_t*)RH_MALLOC(sizeof(__LinkBiTree_t));
#ifdef RH_DEBUG
    RH_ASSERT( pNewNode );
#endif
    pNewNode->object = object;
...
__Stack_t*      __Stack_createBase           ( void* object ){
    __Stack_t *ptr = (__Stack_t*)RH_MALLOC(sizeof(__Stack_t));
#ifdef RH_DEBUG
    RH_ASSERT( ptr );
#endif
...
__Stack_t*      __Stack_push                 ( const __Stack_t *pBase , void* object ){
    ...
    __Stack_t* pNew = (__Stack_t*)RH_MALLOC(sizeof(__Stack_t));
#ifdef RH_DEBUG
    RH_ASSERT( pNew );
#endif
...
__HashMap_t*    __Hash_createMap             ( void ){
    ...
    __HashMap_t *pHashHead = RH_MALLOC( sizeof(__HashMap_t) );
#ifdef RH_DEBUG
    RH_ASSERT( pHashHead );
#endif
    
    __HashList_t* pHashList = RH_MALLOC(RH_HASH_MAP_SIZE*sizeof(__HashList_t));
#ifdef RH_DEBUG
    RH_ASSERT( pHashList );
#endif
...
void            __Hash_pair                  ( const __HashMap_t *pHead, size_t key, void* object ){
    ...
    __SET_STRUCT_MB(__HashList_t, __HashList_t* , pList       , pNext , RH_MALLOC(sizeof(__HashList_t)));
