...
struct tGluObject{
     ...
     * NO MODIFY --- Do NOT modify the following parameters. It will be generated by
                     internal functions.
     ===================================================================================*/
    void (*insert_func)(const struct tGluObject*);  // DO NOT MODIFY
    void (*remove_func)(const struct tGluObject*);  // DO NOT MODIFY
    void (*adjust_func)(const struct tGluObject*);  // DO NOT MODIFY
    const void*   const  cache;                           // DO NOT MODIFY
};
typedef struct tGluObject tGluObject;
