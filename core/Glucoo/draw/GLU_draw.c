...
#ifdef RH_DEBUG
#endif
    BLK_FUNC( Graph, rect_edged )( xs, ys, xe, ye, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
...
#ifdef RH_DEBUG
#endif
    BLK_FUNC( Graph, rect_fill )( xs, ys, xe, ye, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
...
#ifdef RH_DEBUG
#endif
    BLK_FUNC( Graph, rect_round_fill )( xs, ys, xe, ye, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
...
void GLU_FUNC( GUI, circle_raw       )   ( int x , int y , int d ){
    ...
    BLK_FUNC( Graph, circle_raw )( x, y, d, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
...
void GLU_FUNC( GUI, circle_edged     )   ( int x , int y , int d ){
    ...
    int ys = RH_LIMIT( (y-(d>>1)-1), 0, GUI_Y_WIDTH-1 );
    int ye = RH_LIMIT( (y+(d>>1)+1), 0, GUI_Y_WIDTH-1 );
    BLK_FUNC( Graph, circle_edged )( x, y, d, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
...
void GLU_FUNC( GUI, circle_fill      )   ( int x , int y , int d ){
    ...
    int ys = RH_LIMIT( (y-(d>>1)-1), 0, GUI_Y_WIDTH-1 );
    int ye = RH_LIMIT( (y+(d>>1)+1), 0, GUI_Y_WIDTH-1 );
    BLK_FUNC( Graph, circle_fill )( x, y, d, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
...
void GLU_FUNC( GUI, circle_qrt1_fill )   ( int x , int y , int r ){
    ...
    BLK_FUNC( Graph, circle_qrt1_fill )( x, y, r, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
...
void GLU_FUNC( GUI, circle_qrt2_fill )   ( int x , int y , int r ){
    ...
    int ys = RH_LIMIT( (y-r-1), 0, GUI_Y_WIDTH-1 );
    int ye = RH_LIMIT( (y    ), 0, GUI_Y_WIDTH-1 );
    BLK_FUNC( Graph, circle_qrt2_fill )( x, y, r, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
...
void GLU_FUNC( GUI, circle_qrt3_fill )   ( int x , int y , int r ){
    ...
    BLK_FUNC( Graph, circle_qrt3_fill )( x, y, r, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
...
void GLU_FUNC( GUI, circle_qrt4_fill )   ( int x , int y , int r ){
    ...
    int ys = RH_LIMIT( (y    ), 0, GUI_Y_WIDTH-1 );
    int ye = RH_LIMIT( (y+r+1), 0, GUI_Y_WIDTH-1 );
    BLK_FUNC( Graph, circle_qrt4_fill )( x, y, r, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
...
void GLU_FUNC( GUI, circle_qrt1_raw  )   ( int x , int y , int r ){
    ...
    int ys = RH_LIMIT( (y-r-1), 0, GUI_Y_WIDTH-1 );
    int ye = RH_LIMIT( (y    ), 0, GUI_Y_WIDTH-1 );
    BLK_FUNC( Graph, circle_qrt1_raw )( x, y, r, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
void GLU_FUNC( GUI, circle_qrt2_raw  )   ( int x , int y , int r ){
    ...
    int ys = RH_LIMIT( (y-r-1), 0, GUI_Y_WIDTH-1 );
    int ye = RH_LIMIT( (y    ), 0, GUI_Y_WIDTH-1 );
    BLK_FUNC( Graph, circle_qrt2_raw )( x, y, r, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
void GLU_FUNC( GUI, circle_qrt3_raw  )   ( int x , int y , int r ){
    ...
    int ys = RH_LIMIT( (y    ), 0, GUI_Y_WIDTH-1 );
    int ye = RH_LIMIT( (y+r+1), 0, GUI_Y_WIDTH-1 );
    BLK_FUNC( Graph, circle_qrt3_raw )( x, y, r, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
void GLU_FUNC( GUI, circle_qrt4_raw  )   ( int x , int y , int r ){
    ...
    int ys = RH_LIMIT( (y    ), 0, GUI_Y_WIDTH-1 );
    int ye = RH_LIMIT( (y+r+1), 0, GUI_Y_WIDTH-1 );
    BLK_FUNC( Graph, circle_qrt4_raw )( x, y, r, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}

void GLU_FUNC( GUI, capsule_raw      )   ( int xs, int ys, int xe, int ye ){
    BLK_FUNC( Graph, capsule_raw )( xs, ys, xe, ye, info_MainScreen.ptr, NULL );
    GLU_FUNC( GUI, isAutoDisplay )() ? GLU_FUNC( GUI, refreashScreenArea )(xs, ys, xe, ye) : GLU_FUNC( GUI, addScreenArea )(xs, ys, xe, ye);
}
