...
#define COLOR_16BIT(color)                   MAKE_COLOR_16BIT( (((color)>>16)&0xff), (((color)>>8)&0xff), (((color))&0xff) )
#define COLOR_1BIT(color)                    MAKE_COLOR_1BIT( (((color)>>16)&0xff), (((color)>>8)&0xff), (((color))&0xff) )
