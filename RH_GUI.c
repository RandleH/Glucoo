...
// 声明: 插入一个像素点的函数接口
typedef void (*func_InsertPixel)   (int x,int y,Pixel_t color,BufferInfo_t* pBufferInfo);
...
static void __insertCircle               (int x ,int y ,int r ,                                   /************/ Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc);
static void __insertWidenedCircle        (int x ,int y ,int r ,                                   size_t penSize,Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc);
static void __insertFilledCircle         (int x ,int y ,int r ,                                   /************/ Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc);
static void __insertBluredCircle         (int x ,int y ,int r ,                                   /************/ Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc); 

static void __insertLine                 (int x1,int y1,int x2,int y2,                            /************/ Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc);
static void __insertWidenedLine          (int x1,int y1,int x2,int y2,                            size_t penSize,Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc);
static void __insertSausageLine          (int x1,int y1,int x2,int y2,                            size_t penSize,Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc);

static void __insertQuadrilateral        (int x1,int y1,int x2,int y2,int x3,int y3,int x4,int y4,/************/ Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc);
static void __insertFilledQuadrilateral  (int x1,int y1,int x2,int y2,int x3,int y3,int x4,int y4,/************/ Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc);

static void __insertRectangular          (int xs,int ys,int xe,int ye,                            /************/ Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc);
static void __insertWidenedRectangular   (int xs,int ys,int xe,int ye,                            size_t penSize,Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc);
static void __insertFilledRectangular    (int xs,int ys,int xe,int ye,                            /************/ Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc);
static void __insertBluredRectangular    (int xs,int ys,int xe,int ye,                            /************/ Pixel_t penColor,BufferInfo_t* pBufferInfo,func_InsertPixel Call_insertPointFunc);
...
static void __blurArea(int xs,int ys,int xe,int ye ,float delta,float mu,BufferInfo_t* pBufferInfo,func_InsertPixel  Call_insertPointFunc){
