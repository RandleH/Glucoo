...
const unsigned char __GUI_FontByte6X8[] = {
...
const unsigned char __GUI_FontByte8X16[] = {
...
struct GUI_Font{
    ...
    unsigned int          height;
    unsigned int          width;
    size_t                fontArraySize;  
};

static struct GUI_Font GUI_Font6x8  = { .pFont         = __GUI_FontByte6X8          ,\
								        .fontArraySize = sizeof(__GUI_FontByte6X8)  ,\
								        .height        = 8  						,\
								        .width         = 6 };

static struct GUI_Font GUI_Font8x16 = { .pFont         = __GUI_FontByte8X16         ,\
								        .fontArraySize = sizeof(__GUI_FontByte8X16) ,\
								        .height        = 16                         ,\
								        .width         = 8 };
