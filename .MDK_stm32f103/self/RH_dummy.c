...
GUI_Init();
    ...
    gluHandle_t ID_JOY         = GUI_object_create( &cfg_obj );
    ...
    gluHandle_t ID_NUM_1       = GUI_object_create( &cfg_obj );
    
    cfg_obj.area.ys    += cfg_obj.area.height;
    gluHandle_t ID_NUM_2       = GUI_object_create( &cfg_obj );
    ...
    cfg_obj.text        = "Y";
    gluHandle_t ID_TXT_Y       = GUI_object_create( &cfg_obj );
    
    cfg_obj.area.ys    -= cfg_obj.area.height;
    cfg_obj.text        = "X";
    gluHandle_t ID_TXT_X       = GUI_object_create( &cfg_obj );
