...
double __cordic_tan(double rad){
     const static uint16_t angle_65535[] = {
        // When 1 deg = 256, then...
        
        51471 , // Φ = 45              0.78539816339744828     * 65535 = 51471.068638251774  ;   tan(Φ) = 1/1    
        30385 , // Φ = 26.565051177078 0.46364760900080609     * 65535 = 30385.146055867826  ;   tan(Φ) = 1/2    
        16055 , // Φ = 14.036243467927 0.24497866312686414     * 65535 = 16054.676688019041  ;   tan(Φ) = 1/4    
        8150  , // Φ = 26.565051177078 0.12435499454676144     * 65535 = 8149.6045676220110  ;   tan(Φ) = 1/8    
        4091  , // Φ = 26.565051177078 0.06241880999595735     * 65535 = 4090.6167130850649  ;   tan(Φ) = 1/16   
        2047  , // Φ = 26.565051177078 0.031239833430268277    * 65535 = 2047.3024838526317  ;   tan(Φ) = 1/32   
        1024  , // Φ = 26.565051177078 0.015623728620476831    * 65535 = 1023.9010551429492  ;   tan(Φ) = 1/64   
        512   , // Φ = 26.565051177078 0.0078123410601011111   * 65535 = 511.98177137372630  ;   tan(Φ) = 1/128  
        256   , // Φ = 26.565051177078 0.0039062301319669718   * 65535 = 255.99479169845549  ;   tan(Φ) = 1/256  
        128   , // Φ = 26.565051177078 0.0019531225164788188   * 65535 = 127.99788411743938  ;   tan(Φ) = 1/512  
        64    , // Φ = 26.565051177078 0.00097656218955931946  * 65535 = 63.999003092770003  ;   tan(Φ) = 1/1024 
        32    , // Φ = 26.565051177078 0.00048828121119489829  * 65535 = 31.999509175657661  ;   tan(Φ) = 1/2048 
        16    , // Φ = 26.565051177078 0.00024414062014936177  * 65535 = 15.999755541488424  ;   tan(Φ) = 1/4096 
        8     , // Φ = 26.565051177078 0.00012207031189367021  * 65535 = 7.9998778899516774  ;   tan(Φ) = 1/8192 
        4     , // Φ = 26.565051177078 0.000061035156174208773 * 65535 = 3.9999389598767721  ;   tan(Φ) = 1/16384
        2
    };

    long x = 0xffff;
    long y = 0;
    long angle_tar = (long)(rad*65535);
    long angle_sum = 0;
